    ...
    <div class="modal-body" style="padding-bottom: 0">
      ...
      <div class="main-add-new">
        <div style="margin: 0 10px 7px 10px; padding-top: 12px">
          <table style="width: 100%; font-size: 14px">
            <thead style="color: #9b9b9b">
              ...
              <th class="header-table-add-new" style="width: 134px">Status</th>
        ...
        <p style="font-style: italic">
          Service <span style="color: red">*</span>: Trash, light, cleaning,
          ...
          <div class="col" style="display: flex; margin-left: 20px">
            <div class="bill">
              <div style="margin: 10px 25px 10px 20px">
                ...
                <p>
                  Below is the detailed breakdown of living expenses for your
                  room.
                </p>
                <div>
                  <table style="width: 100%; text-align: end">
                    ...
                    <tbody>
                      ...
                      <tr class="row-table-bill">
                        ...
                        <td>
                          {{
                            (waterCurrentMetter - waterPreviousMetter).toFixed(
                              1
                            )
                          }}
                          m³
                      ...
                      <tr class="row-table-bill">
                        <td style="text-align: start">Security Deposit</td>
                        <td>1 month</td>
                        <td>{{ fomatFee(securityDeposite) }}</td>
                        <td>{{ fomatFee(securityDeposite) }}</td>
                      </tr>
                ...
                <p style="font-style: italic">
                  Service <span style="color: red">*</span>: Trash, light,
                  cleaning, laundy, camera, security, parking
                </p>
                <p style="font-style: italic; font-weight: 600">
                  Please complete the payment within the first 5 days of the
                  month from the invoice date. Thanks!
                </p>
              </div>
            </div>
          </div>
...
const selectedRoom = async () => {
  inforOfContract.value = await contractService.getRepesentativeByRoomId(
...
const submitFormExpenses = () => {
  ...
  if (
    securityDeposite.value == 0 &&
    (electricityFee.value == 0 || waterFee.value == 0)
  ) {
    Swal.fire({
      text: "Invalid data",
      icon: "error",
...
const calculateWaterFee = () => {
  if (waterCurrentMetter != 0 && waterPreviousMetter != 0) {
    waterFee.value = Math.round(
      (waterCurrentMetter - waterPreviousMetter) * 35000
    );
    sumTotal();
  }
};
const calculatorElectricFee = () => {
  if (electricityPreviousMetter != 0 && electricityCurrentMetter != 0) {
    electricityFee.value = Math.round(
      (electricityCurrentMetter - electricityPreviousMetter) * 3800
    );
    sumTotal();
  }
};
