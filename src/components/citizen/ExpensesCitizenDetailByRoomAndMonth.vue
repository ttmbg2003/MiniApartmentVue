                ...
                <table style="width: 100%;    font-size: 14px;">
                    ...
                    <tbody>
                        <tr style="height: 35px;background-color: #9c9c9c17;">
                            ...
                            <td><a><i><img src="../icons/eye.png" style="width: 23px;">
                                    </i></a>
                            </td>
                        </tr>
                    </tbody>
                        ...
                        <div style="    margin: 6px;">
                            ...
                            <div class="input-group">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="input-add-new-expenses" disabled />
                                </div>
                                <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="input-add-new-expenses"
                                        v-model="electricityPreviousMetter" disabled />
                                </div>
                                <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="input-add-new-expenses" v-model="service" disabled />
                                </div>
                            </div>
                            <div class="input-group">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Fine</label><br />
                                    <input type="text" class="input-add-new-expenses" v-model="fine" disabled />
                                </div>
                                <div class="form-group">
                            ...
                            <div style="display: flex;justify-content: center;">
                                ...
                                <button v-if="expenses?.status == 'Unpaid' || expenses?.status == 'Partial Paid'" data-bs-toggle="modal" @click="getQrURL"
                                    data-bs-target="#viewQR" class="btn btn-save">Pay now</button>
                            </div>
                        </div>
                    </div>
                </div>
...
const getExpensesDetailByRoom = async () => {
    if (props.roomId != 0) {
        await expensesService.getExpensesCitizenByMonthAndRoom(props.year, props.month, props.roomId).then((res) => {
            expenses.value = res;
        })
...
async function getQrURL(){    
    qrUrl = await paymentService.getPaymentQrURL(props.year, props.month, props.roomId)
    emit('dataEmitted', qrUrl)
}
