<template>
    <div class="main" :style="mainStyle">
        ...
        <form v-if="!otpSent" @submit.prevent="login">
            <input type="text" name="username" id="username" placeholder="Email Address" v-model="email" :style="input" />
            <br />
            <div>
                <input 
                ...
                <i 
                    ...
                    style="position: absolute;top: 46%;transform: translateY(-50%);cursor: pointer;left:68%"
                ></i>
            </div>
    
            <br />
    
            <input type="submit" value="Log in" class="button" id="done" :style="inputStyle" />
        ...
        <div v-if="otpSent" class="modal">
            <div class="modal-content">
                ...
                <form @submit.prevent="verifyOtp">
                    <input type="text" name="otp" id="otp" placeholder="Enter OTP" v-model="otp" :style="input" />
                    <br />
                    <input type="submit" value="Verify OTP" class="button" id="done" :style="inputStyle" />
                    <br />
