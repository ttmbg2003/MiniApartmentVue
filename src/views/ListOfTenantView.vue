                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td v-if="isEditing">
                          <input
                            type="date"
                            v-model="tenantDetail.dateOfBirth"
                            class="input-edit"
                            style="width: 117px"
                          />
                        </td>
                        <td v-else>
                          {{ formatDate(tenantDetail.dateOfBirth) }}
                        </td>
                        <td v-if="isEditing">
                          <input
                            v-model="tenantDetail.contact"
                            class="input-edit"
                            style="width: 125px"
                          />
                        </td>
                        ...
                        <td v-if="isEditing">
                          <input
                            v-model="tenantDetail.citizenId"
                            class="input-edit"
                            style="width: 136px"
                          />
                        </td>
                        ...
                        <td v-if="isEditing">
                          <input
                            v-model="tenantDetail.licensePlate"
                            class="input-edit"
                            style="width: 130px"
                          />
                        </td>
                        ...
                        <td v-if="isEditing">
                          <input
                            v-model="tenantDetail.vehicleType"
                            class="input-edit"
                            style="width: 117px"
                          />
                        </td>
                        ...
                        <td v-if="isEditing">
                          <input
                            v-model="tenantDetail.vehicleColor"
                            class="input-edit"
                            style="width: 117px"
                          />
                        </td>
                        ...
                        <td v-else>
                          ...
                          <div
                            v-if="tenantDetail.residenceStatus == 'In Progress'"
                          ...
                          <a href="#" @click="editTenant()"
                            ><i
                              ><img
                                ...
                                style="width: 23px" /></i
                          ></a>
                          <a href="#" @click="deleteTenant(tenantDetail.email)"
                            ><i
                              ><img
                                src="../components/icons/TrashIcon.png"
                                style="width: 23px" /></i
