          ...
          <div>
            ...
            >
              <template #item-action="item">
                <a @click="showContractDetails(item.contractId)" data-bs-toggle="modal" data-bs-target="#contractDetailModal">
...
const saveContractStatus = () => {
  if (tempContractDetail.value) {
    contractService.updateContractStatus(tempContractDetail.value.contractId, tempContractDetail.value.contractStatus)
      .then(() => {
        ...
        const contract = contracts.value.find(c => c.contractId === tempContractDetail.value.contractId);
        if (contract) {
        ...
        // Close the modal
        const contractDetailModal = document.getElementById('contractDetailModal') as any;
