    ...
    <div style="display: flex;">
        ...
        <div class="container">
            <div class="card">
                ...
                <div>
                        <VueDatePicker v-model="year" year-picker disable-year-select :year-range="[2020, 2040]" placeholder="Select year" style="width: 153px;"/>
                        <VueDatePicker v-model="month" month-picker />
                    <div style="display: flex;justify-content: flex-end;">
                        <p style="margin-right: 31px;margin-bottom: 12px;">Total: {{ clientItemsLength }}</p>
                    </div>
                    <EasyDataTable ref="dataTable" buttons-pagination :headers="headersMain" :items="payment" show-index
                        :must-sort="true" :rows-per-page="10" table-class-name="customize-table">
                        <template #item-action="item">
                            <a data-bs-toggle="modal" data-bs-target="#tenantDetailModal"><i><img
